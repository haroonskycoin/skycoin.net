...
export const downloads = [
  {
    ...
    builds: [{
      ...
      architectures: [{
        ...
        signature: 'https://downloads.skycoin.net/wallet/skycoin-0.25.1-gui-electron-win-setup.exe.asc',
        filetype: '.exe',
        filesize: '68mb',
      }],
    }, {
  ...
  },
  {
    ...
    builds: [
      ...
      },
      {
        ...
        architectures: [{
          name: '',
          download: 'https://downloads.skycoin.net/android/Skycoin-Wallet-v1.5.apk',
          signature: '',
          filetype: '.apk',
          filesize: 'mb',
        }],
